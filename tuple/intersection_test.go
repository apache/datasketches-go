...
func TestIntersection(t *testing.T) {
	...
	t.Run("Summary Sum Policy Applied", func(t *testing.T) {
		sketch1, _ := NewUpdateSketch[*int32Summary, int32](newInt32Summary)
		assert.NoError(t, sketch1.UpdateInt64(1, 10))
		assert.NoError(t, sketch1.UpdateInt64(2, 20))
		assert.NoError(t, sketch1.UpdateInt64(3, 30))

		sketch2, _ := NewUpdateSketch[*int32Summary, int32](newInt32Summary)
		assert.NoError(t, sketch2.UpdateInt64(2, 5))
		assert.NoError(t, sketch2.UpdateInt64(3, 15))
		assert.NoError(t, sketch2.UpdateInt64(4, 25))
...
func TestIntersectionWithDifferentPolicies(t *testing.T) {
	...
	t.Run("Sum With SummaryMergeFunc", func(t *testing.T) {
		...
		assert.NoError(t, sketch1.UpdateInt64(1, 100))
		assert.NoError(t, sketch1.UpdateInt64(2, 200))
		assert.NoError(t, sketch1.UpdateInt64(3, 300))
